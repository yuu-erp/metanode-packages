...
export const generateCodeString = customAlphabet("0123456789abcdef");

export const DEFAULT_MESSAGE_ID_LENGTH = 8;

export function generateMesageId(length = DEFAULT_MESSAGE_ID_LENGTH): string {
